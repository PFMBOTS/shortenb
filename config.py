...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>ʜᴇʟʟᴏ {first} <blockquote>ɪ'ᴍ Aᴠ ꜰɪʟᴇꜱ Sᴛᴏʀᴀɢᴇ ʙᴏᴛ ʏᴏᴜ ᴄᴀɴ ᴀᴄᴄᴇꜱꜱ ᴍᴇ ᴛʜʀᴏᴜɢʜ ᴀ ꜱᴘᴇᴄɪᴀʟ ʟɪɴᴋ ᴀᴠᴀɪʟᴀʙʟᴇ ᴀᴛ @AudioVerseNetwork.</blockquote>")
try:
    ADMINS=[]
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", '<b>{filename} <blockquote>»  ʙʏ @AudioVerseNetwork.</blockquote></b>)')
